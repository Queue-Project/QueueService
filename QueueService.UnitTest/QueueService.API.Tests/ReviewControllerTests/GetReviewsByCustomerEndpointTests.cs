...
public class GetReviewsByCustomerEndpointTests
{
    private readonly Mock<IMediator> _mockMediator;
    private readonly Mock<ILogger<ReviewController>> _mockLogger;
    private readonly ReviewController _reviewController;

    public GetReviewsByCustomerEndpointTests()
    {
    ...
    [Fact]
    public async Task Should_Return_ReviewByCustomer_WithOkStatusCode()
    {
        ...
        // Act
        var result = await _reviewController.GetReviewsByCustomer(1);
