...
public class GetAllQueuesQueryHandlerTests
{
    private readonly Mock<ILogger<GetAllQueuesQueryHandler>> _mockLogger;
    private readonly QueueDbContext _dbContext;
    private readonly Mock<ICacheService> _mockCacheService;
    private readonly Mock<IHttpContextAccessor> _mockAccessor;
    private readonly Mock<IUserService> _mockUserService;
    private readonly GetAllQueuesQueryHandler _handler;

    public GetAllQueuesQueryHandlerTests()
    {
        _mockLogger = new Mock<ILogger<GetAllQueuesQueryHandler>>();
        _dbContext = TestDbContextFactory.Create();
        _mockCacheService = new Mock<ICacheService>();
        _mockAccessor = new Mock<IHttpContextAccessor>();
        _mockUserService = new Mock<IUserService>();
        _handler = new GetAllQueuesQueryHandler(_mockLogger.Object, _dbContext, _mockCacheService.Object,
    ...
    public async Task Handler_Should_Return_Employee_Queues_Successfully()
    {
        ...
        var query = new GetAllQueuesQuery(1);
