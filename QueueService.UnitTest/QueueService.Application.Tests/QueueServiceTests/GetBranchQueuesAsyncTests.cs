...
public class GetBranchQueuesAsyncTests
{
    ...
    public GetBranchQueuesAsyncTests()
    {
     ...
     [Fact]
    public async Task Handler_Should_Return_Branch_Queues_Successfully()
    {
        //Arrange
        ...
        //Act
        var result = await _queueService.GetBranchQueuesAsync(1);
