...
public class QueueCancelByCustomerRequestValidatorTests
{
    private readonly QueueCancelByCustomerRequestValidator _validator;

    public QueueCancelByCustomerRequestValidatorTests()
    {
        _validator = new QueueCancelByCustomerRequestValidator();
    }
    ...
    {
        //Arrange
        var command = new CancelQueueByCustomerCommand(1, "Test Cancel Reason Test Cancel Reason");
    ...
    {
        //Arrange
        var command = new CancelQueueByCustomerCommand(0, "Test Cancel Reason Test Cancel Reason");
    ...
    {
        //Arrange
        var command = new CancelQueueByCustomerCommand(1, "");
    ...
    {
        //Arrange
        var command = new CancelQueueByCustomerCommand(1, "Test");
