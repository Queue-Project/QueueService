...
public class GetAllReviewsByCustomerQueryHandlerTests
{
    private readonly Mock<ILogger<GetReviewsByCustomerQueryHandler>> _mockLogger;
    private readonly QueueDbContext _dbContext;
    private readonly Mock<IHttpContextAccessor> _mockAccessor;
    private readonly Mock<IUserService> _mockUserService;
    private readonly GetReviewsByCustomerQueryHandler _handler;

    public GetAllReviewsByCustomerQueryHandlerTests()
    {
        _mockLogger = new Mock<ILogger<GetReviewsByCustomerQueryHandler>>();
        _dbContext = TestDbContextFactory.Create();
        _mockAccessor = new Mock<IHttpContextAccessor>();
        _mockUserService = new Mock<IUserService>();
        _handler = new GetReviewsByCustomerQueryHandler(_mockLogger.Object, _dbContext, _mockAccessor.Object,
    ...
    public async Task Handler_Should_Return_AllReviews_When_User_Is_Customer_Successfully()
    {
        ...
        var query = new GetReviewsByCustomerQuery(1);
